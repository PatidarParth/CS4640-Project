...
<div class="image" >
  ...
  <form action="confirmation.jsp" method="get" id="form1">
    <h2 id="WorkoutFont">Focusing on: <?php echo implode(", ", $choices)?></h2>
    <h2 id="WorkoutFont">Name this workout:</h2> 
    <input text-align= "center" class="form-control" name="workoutName" id="workoutName"></br>
      <h2 id="WorkoutFont">Number of exercises selected:</h2><p id="numselected" name= "numselected">0</p>
